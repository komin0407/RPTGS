...
RPTGSCapTD3 class (return-priority, norm-balanced two-task PCGrad; SiLU forced;
...
from td3.models.rptgs_cap_td3 import RPTGSCapTD3  # noqa: E402
...
@th.no_grad()
def evaluate_policy(model: RPTGSCapTD3, validation_seeds: list[int]) -> list[dict[str, object]]:
    env = gym.make(ENV_ID)
