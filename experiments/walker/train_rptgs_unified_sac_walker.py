#!/usr/bin/env python3
"""RPTGS-SAC (PAVE/sac/models/rptgs_sac.py) on Walker2d-v5.

Norm-balanced gradient surgery variant (the original RPTGS): the temporal
...
(train_rptgs_sac*.py): RPTGSUnifiedSAC (return-priority, norm-balanced
