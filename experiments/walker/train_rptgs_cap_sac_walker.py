#!/usr/bin/env python3
"""RPTGS-Cap-SAC (PAVE/sac/models/rptgs_cap_sac.py) on Walker2d-v5.
...
identical to train_rptgs_sac_walker.py.

Identical hyperparameters to the Pendulum/LunarLander/Reacher SAC runs
(train_rptgs_sac*.py): RPTGSCapSAC (return-priority, cap-only
