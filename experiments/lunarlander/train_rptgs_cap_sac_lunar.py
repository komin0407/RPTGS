#!/usr/bin/env python3
"""RPTGS-Cap-SAC (PAVE/sac/models/rptgs_cap_sac.py) on LunarLander-v3 (continuous).
...
identical to train_rptgs_sac_lunar.py.

Identical hyperparameters to the Pendulum SAC run: RPTGSCapSAC class
