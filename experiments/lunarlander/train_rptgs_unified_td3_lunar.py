#!/usr/bin/env python3
"""RPTGS-TD3 (PAVE/td3/models/rptgs_td3.py) on LunarLanderContinuous-v3.

Identical hyperparameters to the Pendulum runs (train_rptgs_sb3.py): same
RPTGSUnifiedTD3 class (return-priority, norm-balanced two-task PCGrad; SiLU forced;
...
@th.no_grad()
def evaluate_policy(model: RPTGSUnifiedTD3, validation_seeds: list[int]) -> list[dict[str, object]]:
