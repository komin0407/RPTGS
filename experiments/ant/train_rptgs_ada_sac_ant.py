#!/usr/bin/env python3
"""RPTGS-Ada-SAC (PAVE/sac/models/rptgs_ada_sac.py) on Ant-v5.
...
train_rptgs_sac_ant.py.

Identical hyperparameters to the Pendulum/LunarLander/Reacher SAC runs
(train_rptgs_sac*.py): RPTGSAdaSAC (return-priority, alignment-adaptive
...
from sac.models.rptgs_ada_sac import RPTGSAdaSAC  # noqa: E402
...
@th.no_grad()
def evaluate_policy(model: RPTGSAdaSAC, validation_seeds: list[int]) -> list[dict[str, object]]:
    env = gym.make(ENV_ID)
