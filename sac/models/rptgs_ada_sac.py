...
def _set_two_task_adagrad(
    ...
    Self-tuning unification of the norm-balanced (RPTGSSAC) and cap-only
    (RPTGSCapSAC) merge geometries. The amplification granted to the temporal
...
class RPTGSAdaSAC(SAC):
    """Alignment-adaptive Return-Priority Two-task Gradient Surgery SAC (RPTGS-Ada).

    Self-tuning unification of RPTGSSAC (norm-balanced) and RPTGSCapSAC
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            # -----------------------------------------------------------
            # [RPTGS-Ada Actor Update -- alignment-adaptive two-task surgery]
            # -----------------------------------------------------------
        ...
        if len(cosines) > 0:
            ...
            self.logger.record("train/rptgs_alpha", np.mean(alphas))
